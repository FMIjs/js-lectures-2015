# 02. Функционално Програмиране с Javascript - Задачи

1. Направете функция която която приема произволен брой аргументи и връща сумата от квадратите на нечетните аргументи (числа, а не по индекси).
